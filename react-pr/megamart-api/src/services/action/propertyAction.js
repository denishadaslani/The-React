...
export const deleteProductAsync = (id) => {
    return (dispatch) => {
        console.log(id);
        axios.delete(`http://localhost:3000/products/${Number(id)}`)
...
export const getProductAsync = (id) => {
    return (dispatch) => {
        axios.get(`http://localhost:3000/products/${Number(id)}`)
...
export const updateProductAsync = (data) => {
    return (dispatch) => {
        axios.put(`http://localhost:3000/products/${Number(data.id)}`, data)
